...
class FashionViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        //        self.navigationController?.navigationBar.titleTextAttributes = [NSForegroundColorAttributeName : UIColor(red: 252, green: 120, blue: 128, alpha: 1.0)]
        self.navigationController?.navigationBar.tintColor = UIColor(red: 252/255, green: 120/255, blue: 128/255, alpha: 1.0)
    }
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "toSaveVC"{
            let saveViewController:SaveViewController = segue.destinationViewController as! SaveViewController
            SaveViewController.year = self.year
            
            SaveViewController.month = self.month
            
            SaveViewController.day = self.day
